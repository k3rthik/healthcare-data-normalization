...
load_data_task = PythonOperator(
    task_id="load_data", python_callable=load_data, provide_context=True, dag=dag
)
forecast_data_task = PythonOperator(
    task_id="forecast_data", python_callable=forecast_data, dag=dag
)
